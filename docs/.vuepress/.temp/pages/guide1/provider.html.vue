<template><div><hr>
<h2 id="lang-zh-cntitle-provider2-服务提供者命令date-2023-09-02description-provider2-服务提供者命令指南sidebar-auto" tabindex="-1"><a class="header-anchor" href="#lang-zh-cntitle-provider2-服务提供者命令date-2023-09-02description-provider2-服务提供者命令指南sidebar-auto" aria-hidden="true">#</a> lang: zh-CN
title: provider2 服务提供者命令
date: 2023-09-02
description: provider2 服务提供者命令指南
sidebar: auto</h2>
<h2 id="provider-服务提供者命令" tabindex="-1"><a class="header-anchor" href="#provider-服务提供者命令" aria-hidden="true">#</a> provider 服务提供者命令</h2>
<p>webgo框架使用ServiceProvider机制来满足协议，通过service Provder提供某个协议服务的具体实现。这样如果开发者对具体的实现协议的服务类的具体实现不满意，则可以很方便的通过切换具体协议的Service Provider来进行具体服务的切换。</p>
...
<p>我们可以使用命令 <code v-pre>./webgo provider new</code> 来创建一个新的service provider</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>[~/Documents/workspace/webgo_workspace/demo5]$ ./webgo provider new
create a provider
...
<p>contract.go 定义了这个服务提供方提供的协议接口。webgo 框架任务，作为一个业务的服务提供者，定义一个好的协议是最重要的事情。</p>
...
<p>webgo的路由，controller的定义是选择基于gin框架进行扩展的。所有的gin框架的路由，参数获取，验证，context都和gin框架是相同的。唯一不同的是gin的全局路由gin.Engine实现了webgo的容器结构，可以对gin.Engine进行服务提供的注入，且可以从context中获取具体的服务。</p>
<p>webgo提供两种服务注入的方法：</p>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="webgo-provider" tabindex="-1"><a class="header-anchor" href="#webgo-provider" aria-hidden="true">#</a> webgo provider</h2>
<p>webgo 框架默认自带了一些服务提供者，提供基础的服务接口协议，可以通过 <code v-pre>./webgo provider list</code> 来获取已经安装的服务提供者。</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>[~/Documents/workspace/webgo_workspace/demo5]$ ./webgo provider list
webgo:app
webgo:env
webgo:config
webgo:log
webgo:ssh
webgo:kernel
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>webgo 框架自带的服务提供者的 key 是以 <code v-pre>webgo:</code> 开头。目的为的是与自定义服务提供者的 key 区别开。</p>
<p>webgo 框架自带的服务提供者具体定义的协议可以参考：<a href="/provider/" target="_blank" rel="noopener noreferrer">provider<ExternalLinkIcon/></a></p>
</div></template>
