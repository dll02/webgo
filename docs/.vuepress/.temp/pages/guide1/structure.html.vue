<template><div><hr>
<h2 id="lang-zh-cntitle-目录结构date-2023-09-02description-目录结构sidebar-auto" tabindex="-1"><a class="header-anchor" href="#lang-zh-cntitle-目录结构date-2023-09-02description-目录结构sidebar-auto" aria-hidden="true">#</a> lang: zh-CN
title: 目录结构
date: 2023-09-02
description: 目录结构
sidebar: auto</h2>
<h2 id="目录结构" tabindex="-1"><a class="header-anchor" href="#目录结构" aria-hidden="true">#</a> 目录结构</h2>
<p>webgo 框架不仅仅是一个类库，也是一个定义了开发模式和目录结构的框架。 webgo 希望所有使用这个框架的开发人员遵照统一的项目结构进行开发。
默认创建的项目结构为：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>[~/Documents/workspace/webgo_workspace/demo5]$ tree
.
├── README.md
├── app // 服务端应用地址
│   ├── console  // 存放自定义命令
...
<p>第一步：创建当前业务的 provider。可以使用命令行 <code v-pre>./webgo provider new</code> 来创建。</p>
