...
hade:ssh
hade:kernel
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>hade 框架自带的服务提供者的 key 是以 <code>hade:</code> 开头。目的为的是与自定义服务提供者的 key 区别开。</p>`,46);function u(m,b){const i=r("RouterLink");return d(),a("div",null,[o,s("p",null,[e("hade 框架自带的服务提供者具体定义的协议可以参考："),l(i,{to:"/provider/"},{default:v(()=>[e("provider")]),_:1})])])}const g=n(c,[["render",u],["__file","provider.html.vue"]]);export{g as default};
