import{_ as d,r,o as l,c,a as s,b as e,e as n,d as i}from"./app-2d690129.js";const t={},o=s("h1",{id:"swagger",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#swagger","aria-hidden":"true"},"#"),e(" swagger")],-1),v=s("h2",{id:"命令",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#命令","aria-hidden":"true"},"#"),e(" 命令")],-1),g={href:"https://github.com/swaggo/swag",target:"_blank",rel:"noopener noreferrer"},u=s("code",null,"./webgo swagger",-1),m=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[~/Documents/workspace/webgo_workspace/demo5]$ ./webgo swagger
swagger operator
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),b={href:"https://github.com/swaggo/swag",target:"_blank",rel:"noopener noreferrer"},w=i(`<h2 id="生成" tabindex="-1"><a class="header-anchor" href="#生成" aria-hidden="true">#</a> 生成</h2><p>使用命令 <code>./webgo swagger gen</code></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[~/Documents/workspace/webgo_workspace/demo5]$ ./webgo swagger gen
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在目录 <code>app/http/swagger/</code> 下自动生成swagger相关文件。</p><h2 id="服务" tabindex="-1"><a class="header-anchor" href="#服务" aria-hidden="true">#</a> 服务</h2><p>可以使用命令 <code>./webgo swagger serve</code> 启动当前应用的 swagger ui 服务。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[~/Documents/workspace/webgo_workspace/demo5]$ ./webgo swagger serve
swagger success: http://0.0.0.0:8069/swagger/index.html
if you want to replace, remember use command: swagger gen
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>如果你的 swagger 服务已经启动，更新 swagger 只需要重新运行 <code>./webgo swagger gen</code> 就能更新。因为 swagger 服务读取的是生成的 swagger.json 这个文件。</p></div><p>服务端口，我们也可以通过配置文件 <code>config/[env]/swagger.yaml</code> 中的配置</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>url: http://127.0.0.1:8069
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>来配置swagger serve 启动的服务。</p>`,11);function _(x,f){const a=r("ExternalLinkIcon");return l(),c("div",null,[o,v,s("p",null,[e("webgo 使用 "),s("a",g,[e("swaggo"),n(a)]),e(" 集成了 swagger 生成和服务项目。并且封装了 "),u,e(" 命令。")]),m,s("p",null,[e("webgo 使用 "),s("a",h,[e("swaggo"),n(a)]),e(" 来实现注释生成 swagger 功能。")]),p,s("p",null,[e("swagger 注释的格式和关键词可以参考："),s("a",b,[e("swaggo"),n(a)])]),w])}const D=d(t,[["render",_],["__file","swagger.html.vue"]]);export{D as default};
