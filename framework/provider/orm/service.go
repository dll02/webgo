...
// WebgoGorm 代表webgo框架的orm实现
type WebgoGorm struct {
...
// NewWebgoGorm 代表实例化Gorm
func NewWebgoGorm(params ...interface{}) (interface{}, error) {
...
// GetDB 获取DB实例
func (app *WebgoGorm) GetDB(option ...contract.DBOption) (*gorm.DB, error) {
