...
// WebgoRedis 代表webgo框架的redis实现
type WebgoRedis struct {
...
// NewWebgoRedis 代表实例化Client
func NewWebgoRedis(params ...interface{}) (interface{}, error) {
...
func (app *WebgoRedis) GetClient(option ...contract.RedisOption) (*redis.Client, error) {
	// 读取默认配置
